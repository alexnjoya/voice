     ...
     setTimeout(() => {
       ...
       switch (option) {
         case "Tell me about Alex":
           response = "Alex Njoya is a final-year Computer Science student at University of Ghana with strong experience in software development, frontend engineering, and blockchain application development. He's currently a Co-Founder at FineTun-ai.";
           break;
         case "What's his experience?":
           response = "Alex has worked as Co-Founder at FineTun-ai, Frontend Developer at Next Code Systems, Volunteer Frontend Developer at Mowblox, and Blockchain Developer at MEST Africa.";
           break;
         case "What are his skills?":
           response = "Alex's skills include JavaScript, TypeScript, Python, Solidity, React.js, Next.js, Tailwind CSS, Smart Contracts, Remix, Hardhat, Ethereum, Git, and Agile methodologies.";
           break;
         case "Tell me about FineTun-ai":
           response = "FineTun-ai is a startup where Alex is Co-Founder, focused on enabling businesses to fine-tune Large Language Models (LLMs) using their proprietary datasets.";
           break;
         case "What projects has he built?":
           response = "Alex has built Tally (Blockchain-Based Voting DApp) and AdwumaPa (Blockchain Freelance Platform) - both innovative Web3 applications.";
           break;
         case "How can I contact him?":
           response = "You can reach Alex at njoyaalexander71@gmail.com or +233 240 027 151. He's available for remote work and blockchain development opportunities.";
           break;
         default:
